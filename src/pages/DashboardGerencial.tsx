        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5">
            ...
            <input
              ...
              className="px-3 py-1.5 w-[120px] text-sm bg-[var(--bg-input)] border border-[var(--border)] rounded-lg text-[var(--text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--accent)]/20 text-center font-mono"
            />
